...
if [[ "$x" == "1" ]]; then
    sshpass -p 'Weihnachten2023' ssh czaja@192.168.178.144 '/home/czaja/setup_board.sh'
elif [[ "$x" == "2" ]]; then
    sshpass -p 'Weihnachten2023' ssh czaja@192.168.178.144 '/home/czaja/update_board.sh'
elif [[ "$x" == "3" ]]; then
    sshpass -p 'Weihnachten2023' ssh czaja@192.168.178.144 '/home/czaja/board_shutdown.sh'
else
